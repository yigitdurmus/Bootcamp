...
public class WhiteLabelManager : MonoBehaviour
{
    ...
    public static bool TogleControl = true;
    ...
    public void AutoLogin()
    {
        ...
        if (Convert.ToBoolean(rememberMe) == true && TogleControl == true)
        {
        ...
        else if(Convert.ToBoolean(rememberMe) == false || TogleControl == false)
        {
            // Continue as usual
